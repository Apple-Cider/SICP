...
(define sample-decoded (decode sample-message sample-tree))

(define sample-encoded (encode sample-decoded sample-tree))

(define sample-re-decoded (decode sample-encoded sample-tree))
