...
(define sample-tree-automated
  (generate-huffman-tree (list (list 'A 4)
                               (list 'B 2)
                               (list 'C 1)
                               (list 'D 1))))
...
(define sample-decoded-0 (decode sample-message sample-tree))
(define sample-decoded-1 (decode sample-message sample-tree-automated))

(define sample-encoded-0 (encode sample-decoded-0 sample-tree))
(define sample-encoded-1 (encode sample-decoded-0 sample-tree-automated))
